  ...
  [
    {
     ...
     // Permissions to apply to the user signing in.
     permission:
      [
        { $type: String, required: true, validate: [core.mongodb.validation.rule.required, core.mongodb.validation.rule.permission] },
      ],
    },
  ],
